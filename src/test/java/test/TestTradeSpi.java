...
import thosttraderapi.CThostFtdcAccountregisterField;
import thosttraderapi.CThostFtdcBrokerTradingAlgosField;
import thosttraderapi.CThostFtdcBrokerTradingParamsField;
import thosttraderapi.CThostFtdcCFMMCTradingAccountKeyField;
import thosttraderapi.CThostFtdcCancelAccountField;
import thosttraderapi.CThostFtdcChangeAccountField;
import thosttraderapi.CThostFtdcContractBankField;
import thosttraderapi.CThostFtdcDepthMarketDataField;
import thosttraderapi.CThostFtdcEWarrantOffsetField;
import thosttraderapi.CThostFtdcErrorConditionalOrderField;
import thosttraderapi.CThostFtdcExchangeField;
import thosttraderapi.CThostFtdcInputOrderActionField;
import thosttraderapi.CThostFtdcInputOrderField;
import thosttraderapi.CThostFtdcInstrumentCommissionRateField;
import thosttraderapi.CThostFtdcInstrumentField;
import thosttraderapi.CThostFtdcInstrumentMarginRateField;
import thosttraderapi.CThostFtdcInstrumentStatusField;
import thosttraderapi.CThostFtdcInvestorField;
import thosttraderapi.CThostFtdcInvestorPositionCombineDetailField;
import thosttraderapi.CThostFtdcInvestorPositionDetailField;
import thosttraderapi.CThostFtdcInvestorPositionField;
import thosttraderapi.CThostFtdcNoticeField;
import thosttraderapi.CThostFtdcNotifyQueryAccountField;
import thosttraderapi.CThostFtdcOpenAccountField;
import thosttraderapi.CThostFtdcOrderActionField;
import thosttraderapi.CThostFtdcOrderField;
import thosttraderapi.CThostFtdcParkedOrderActionField;
import thosttraderapi.CThostFtdcParkedOrderField;
import thosttraderapi.CThostFtdcQryTradingAccountField;
import thosttraderapi.CThostFtdcQueryMaxOrderVolumeField;
import thosttraderapi.CThostFtdcRemoveParkedOrderActionField;
import thosttraderapi.CThostFtdcRemoveParkedOrderField;
import thosttraderapi.CThostFtdcReqQueryAccountField;
import thosttraderapi.CThostFtdcReqRepealField;
import thosttraderapi.CThostFtdcReqTransferField;
import thosttraderapi.CThostFtdcReqUserLoginField;
import thosttraderapi.CThostFtdcRspAuthenticateField;
import thosttraderapi.CThostFtdcRspInfoField;
import thosttraderapi.CThostFtdcRspRepealField;
import thosttraderapi.CThostFtdcRspTransferField;
import thosttraderapi.CThostFtdcRspUserLoginField;
import thosttraderapi.CThostFtdcSettlementInfoConfirmField;
import thosttraderapi.CThostFtdcSettlementInfoField;
import thosttraderapi.CThostFtdcTradeField;
import thosttraderapi.CThostFtdcTraderApi;
import thosttraderapi.CThostFtdcTraderSpi;
import thosttraderapi.CThostFtdcTradingAccountField;
import thosttraderapi.CThostFtdcTradingAccountPasswordUpdateField;
import thosttraderapi.CThostFtdcTradingCodeField;
import thosttraderapi.CThostFtdcTradingNoticeField;
import thosttraderapi.CThostFtdcTradingNoticeInfoField;
import thosttraderapi.CThostFtdcTransferBankField;
import thosttraderapi.CThostFtdcTransferSerialField;
import thosttraderapi.CThostFtdcUserLogoutField;
import thosttraderapi.CThostFtdcUserPasswordUpdateField;
import thosttraderapi.ThosttraderapiLibrary;

/**
 * Copyright (c) 2011-2013, z16304607@163.com Created with IntelliJ IDEA. User:
 * trade Date: 13-5-16 Time: 下午10:25 To change this template use File | Settings
 * | File Templates.
 */
public class TestTradeSpi extends CThostFtdcTraderSpi {
	 ...
	 */
	@Virtual(3)
	public void OnRspAuthenticate(Pointer<CThostFtdcRspAuthenticateField> pRspAuthenticateField,
	 ...
	 */
	@Virtual(4)
	public void OnRspUserLogin(Pointer<CThostFtdcRspUserLoginField> pRspUserLogin,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
		...
		String msg = String.format(
				"BrokerID = %s UserID = %s TradingDay = %s FrontID = %d SessionID = %d MaxOrderRef = %s",
				rspLogin.BrokerID().getCString(), rspLogin.UserID().getCString(), rspLogin.TradingDay().getCString(),
				rspLogin.FrontID(), rspLogin.SessionID(), rspLogin.MaxOrderRef().getCString());
		 ...
		 */
		/*
		 * CThostFtdcSettlementInfoConfirmField req = new
		 * CThostFtdcSettlementInfoConfirmField( ) ; req.setBrokerID( this.m_brokerID )
		 ...
		 * ) ; info.BrokerID( ).setCString( this.m_brokerID ) ; info.InvestorID(
		 * ).setCString( this.m_userID ) ; this.m_api.ReqQrySettlementInfo(
		 * Pointer.pointerTo( info ) , 3 ) ;
		 * 
		 * try { Thread.sleep( 1000 ) ; } catch( Exception e ) { System.out.println( e )
		 * ; }
		 */
	 ...
	 */
	@Virtual(6)
	public void OnRspUserPasswordUpdate(Pointer<CThostFtdcUserPasswordUpdateField> pUserPasswordUpdate,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(8)
	public void OnRspOrderInsert(Pointer<CThostFtdcInputOrderField> pInputOrder,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(9)
	public void OnRspParkedOrderInsert(Pointer<CThostFtdcParkedOrderField> pParkedOrder,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(10)
	public void OnRspParkedOrderAction(Pointer<CThostFtdcParkedOrderActionField> pParkedOrderAction,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(11)
	public void OnRspOrderAction(Pointer<CThostFtdcInputOrderActionField> pInputOrderAction,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(12)
	public void OnRspQueryMaxOrderVolume(Pointer<CThostFtdcQueryMaxOrderVolumeField> pQueryMaxOrderVolume,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(14)
	public void OnRspRemoveParkedOrder(Pointer<CThostFtdcRemoveParkedOrderField> pRemoveParkedOrder,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(16)
	public void OnRspQryOrder(Pointer<CThostFtdcOrderField> pOrder, Pointer<CThostFtdcRspInfoField> pRspInfo,
	 ...
	 */
	@Virtual(17)
	public void OnRspQryTrade(Pointer<CThostFtdcTradeField> pTrade, Pointer<CThostFtdcRspInfoField> pRspInfo,
			int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(18)
	public void OnRspQryInvestorPosition(Pointer<CThostFtdcInvestorPositionField> pInvestorPosition,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(19)
	public void OnRspQryTradingAccount(Pointer<CThostFtdcTradingAccountField> pTradingAccount,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(20)
	public void OnRspQryInvestor(Pointer<CThostFtdcInvestorField> pInvestor, Pointer<CThostFtdcRspInfoField> pRspInfo,
			int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(21)
	public void OnRspQryTradingCode(Pointer<CThostFtdcTradingCodeField> pTradingCode,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(24)
	public void OnRspQryExchange(Pointer<CThostFtdcExchangeField> pExchange, Pointer<CThostFtdcRspInfoField> pRspInfo,
			int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(25)
	public void OnRspQryInstrument(Pointer<CThostFtdcInstrumentField> pInstrument,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(26)
	public void OnRspQryDepthMarketData(Pointer<CThostFtdcDepthMarketDataField> pDepthMarketData,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(27)
	public void OnRspQrySettlementInfo(Pointer<CThostFtdcSettlementInfoField> pSettlementInfo,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(30)
	public void OnRspQryNotice(Pointer<CThostFtdcNoticeField> pNotice, Pointer<CThostFtdcRspInfoField> pRspInfo,
			int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(34)
	public void OnRspQryEWarrantOffset(Pointer<CThostFtdcEWarrantOffsetField> pEWarrantOffset,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(35)
	public void OnRspQryTransferSerial(Pointer<CThostFtdcTransferSerialField> pTransferSerial,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	...
	public void OnRtnOrder(Pointer<CThostFtdcOrderField> pOrder) {
		...
		String msg = String.format(
				"OnRtnOrder : OrderSysID = %s InstrumentID = %s LimitPrice = %f VolumeTotalOriginal = %d OrderStatus = %c",
				order.OrderSysID().getCString().trim(), order.InstrumentID().getCString(), order.LimitPrice(),
				order.VolumeTotalOriginal(), order.OrderStatus());
	 ...
	 */
	@Virtual(40)
	public void OnErrRtnOrderInsert(Pointer<CThostFtdcInputOrderField> pInputOrder,
	 ...
	 */
	@Virtual(41)
	public void OnErrRtnOrderAction(Pointer<CThostFtdcOrderActionField> pOrderAction,
			Pointer<CThostFtdcRspInfoField> pRspInfo) {
	 ...
	 */
	@Virtual(45)
	public void OnRspQryContractBank(Pointer<CThostFtdcContractBankField> pContractBank,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(46)
	public void OnRspQryParkedOrder(Pointer<CThostFtdcParkedOrderField> pParkedOrder,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(47)
	public void OnRspQryParkedOrderAction(Pointer<CThostFtdcParkedOrderActionField> pParkedOrderAction,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(48)
	public void OnRspQryTradingNotice(Pointer<CThostFtdcTradingNoticeField> pTradingNotice,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(50)
	public void OnRspQryBrokerTradingAlgos(Pointer<CThostFtdcBrokerTradingAlgosField> pBrokerTradingAlgos,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(60)
	public void OnErrRtnBankToFutureByFuture(Pointer<CThostFtdcReqTransferField> pReqTransfer,
			Pointer<CThostFtdcRspInfoField> pRspInfo) {
	 ...
	 */
	@Virtual(61)
	public void OnErrRtnFutureToBankByFuture(Pointer<CThostFtdcReqTransferField> pReqTransfer,
			Pointer<CThostFtdcRspInfoField> pRspInfo) {
	 ...
	 */
	@Virtual(62)
	public void OnErrRtnRepealBankToFutureByFutureManual(Pointer<CThostFtdcReqRepealField> pReqRepeal,
			Pointer<CThostFtdcRspInfoField> pRspInfo) {
	 ...
	 */
	@Virtual(63)
	public void OnErrRtnRepealFutureToBankByFutureManual(Pointer<CThostFtdcReqRepealField> pReqRepeal,
			Pointer<CThostFtdcRspInfoField> pRspInfo) {
	 ...
	 */
	@Virtual(67)
	public void OnRspFromBankToFutureByFuture(Pointer<CThostFtdcReqTransferField> pReqTransfer,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(68)
	public void OnRspFromFutureToBankByFuture(Pointer<CThostFtdcReqTransferField> pReqTransfer,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
	 ...
	 */
	@Virtual(69)
	public void OnRspQueryBankAccountMoneyByFuture(Pointer<CThostFtdcReqQueryAccountField> pReqQueryAccount,
			Pointer<CThostFtdcRspInfoField> pRspInfo, int nRequestID, boolean bIsLast) {
